...
<body>
   ...
   <form class="form-signin" action="" method="post">
    ...
    <label for="inputEmail" class="sr-only">UCSC email</label>
    <br>
    <input type="email" name="id" id="inputEmail" class="form-control" placeholder="Enter your UCSC email" required autofocus>
    <br>
